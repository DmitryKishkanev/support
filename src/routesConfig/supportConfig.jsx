...
export const supportConfig = [
  ...
  },
  {
    ...
    description:
      'Приложение реализовано на основе функциональных компонентов React. Для управления состоянием и взаимодействия с серверной частью используется Redux Toolkit с RTK Query. Пользователь может выполнить поиск покемона по имени: при отправке запроса сначала отображается индикатор загрузки, затем — карточка с информацией о найденном покемоне. В случае ввода несуществующего имени или случайного набора символов после индикатора появится сообщение об ошибке и изображение‑заглушка.',
    element: <RTKQueryPokemon />,
  },
  {
    path: 'RTKQueryPhonebookApp',
    label: 'RTKQueryPhonebook',
    description:
      'Приложение реализовано на основе функциональных компонентов React. Для управления состоянием и взаимодействия с серверной частью используется Redux Toolkit с RTK Query. Основная задача приложения — хранение имён и номеров телефонов в формате классической телефонной книги. Реализованы ключевые функции: добавление новых контактов, удаление существующих и фильтрация списка по имени',
    element: <RTKQueryPhonebookApp />,
  },
  {
    path: 'RTKQueryMaterialRenderComponent',
    label: 'RTKQueryMaterials',
    description:
  ...
  },
  {
    ...
    description:
      'Приложение разработано на основе функциональных компонентов React. Управление состоянием и взаимодействие с серверной частью реализованы через асинхронный Redux с использованием библиотеки axios, что демонстрирует практическое применение внешнего хранилища данных. Приложение представляет собой классическую телефонную книгу: оно позволяет сохранять имена и номера телефонов, добавлять новые записи, редактировать существующие, удалять ненужные и фильтровать контакты по имени.',
